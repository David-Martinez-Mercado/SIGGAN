...
import {
  LayoutDashboard, Bug, Users, MapPin, Syringe,
  Tags, Search, ShoppingCart, LogOut, Menu, X
} from 'lucide-react';
      ...
      `}>
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-emerald-400">🐄 SIGGAN</h1>
              <p className="text-xs text-gray-400 mt-1">Gestión Ganadera Integral</p>
            </div>
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleLogout} className="text-gray-400 hover:text-red-400" title="Cerrar sesión">
              <LogOut size={18} />
            </button>
          </div>
        </div>
